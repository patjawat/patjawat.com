...
?>
<div class="blog_template bdp_blog_template timeline blog-wrap <?php echo $alter_class; ?>">
            ...
            <div class="post_wrapper box-blog">
                ...
                <div class="desc">
                    ...
                    if ($bdp_settings['rss_use_excerpt'] == 1 && $read_more_link == 1):
                        ...
                        <div class="read_more">
                            <?php
                            echo '<a class="btn-more" href="' . $post_link . '"><i class="fas fa-plus"></i> ' . $readmoretxt . ' </a>';
                            ?>
                        </div>
                    <?php endif; ?>
                </div>
