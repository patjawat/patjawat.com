        ...
        <div id="poststuff">
            <div class="postbox-container bd-settings-wrappers bd_poststuff">
                ...
                <div class="bd-menu-setting">
                    <?php
                    $bdpgeneral_class = $dbptimeline_class = $bdpstandard_class = $bdptitle_class = $bdpauthor_class = $bdpcontent_class = $bdpmedia_class = $bdpslider_class = $bdpsocial_class = $bdpfilter_class = '';
                    $bdpgeneral_class_show = $dbptimeline_class_show = $bdpstandard_class_show = $bdptitle_class_show = $bdpauthor_class_show = $bdpcontent_class_show = $bdpmedia_class_show = $bdpslider_class_show = $bdpsocial_class_show = $bdpfilter_class_show = '';
                                ...
                                <div class="bdp-typography-wrapper bdp-button-settings">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Show post publish date on archive layout', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover display_comment">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Show post comment on archive layout', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover display-postlike">
                                        <div class="bdp-typography-label">
                                            <span class="bd-key-title">
                                                <?php _e('Post Post Like', BLOGDESIGNERPRO_TEXTDOMAIN) ?>
                                            </span>
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Show post like on archive layout', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover display_year">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Show post published year on archive layout', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                            ...
                            <li class="archive_pagination_type">
                                ...
                                <div class="bdp-right">
                                    ...
                                    <select name="pagination_type" id="pagination_type">
                                        <?php $pagination_type = isset($bdp_settings['pagination_type']) ? $bdp_settings['pagination_type'] : 'no_pagination'; ?>
                    ...
                    <div class="inside">
                        <ul class="bdp-settings bdp-lineheight">
                            ...
                            <li class="display_author_biography_div">
                                ...
                                <div class="bdp-right">
                                    <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable author social share links', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                    <fieldset class="bdp-social-options bdp-display_author buttonset">
                                ...
                                <div class="bdp-typography-wrapper">
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable email link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable website link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable google plus link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable facebook link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable twitter link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable linkedin link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable youtube link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable pinterest link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable instagram link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable reddit link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable pocket link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable skype link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable wordpress link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable snapchat link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable vine link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                                    ...
                                    <div class="bdp-typography-cover">
                                        <div class="bdp-typography-label">
                                            ...
                                            <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enable/Disable tumblr link', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                        </div>
                                        <div class="bdp-typography-content">
                        ...
                        <ul class="bdp-settings bdp-lineheight">
                            ...
                            <li class="read_more_wrap custom_link_url">
                                <div class="bdp-left">
                                    ...
                                    <span class="fas fa-question-circle bdp-tooltips-icon"><span class="bdp-tooltips"><?php _e('Enter custom_link_url.', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                </div>
                                <div class="bdp-right">
                    ...
                    <div class="inside">
                        <ul class="bdp-settings bdp-lineheight">
                            ...
                            <li class ="social_share_options default_icon_layouts">
                                ...
                                <div class="bdp-right">
                                    <span class="fas fa-question-circle bdp-tooltips-icon bdp-tooltips-icon-color"><span class="bdp-tooltips"><?php _e('Select icon theme from available icon theme', BLOGDESIGNERPRO_TEXTDOMAIN); ?></span></span>
                                    <?php
