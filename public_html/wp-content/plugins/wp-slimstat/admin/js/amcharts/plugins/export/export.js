					...
					if ( _this.drawing.buffer.line ) {
						...
						for ( i1 = 0; i1 < l.group.length; i1++ ) {
							...
							if ( obj instanceof fabric.Line ) {
								...
								if ( l.arrow == "start" ) {
									top = l.y1 + ( l.widthÀ7    À7                    áæ            pYµ    (8            à7     @      à7            top = l.y2 + ( l.width / 2 ) - ( ( l.y2 - l.y1 ) / 2 );
...
À7    À7                    áæ            pYµ    (8            à7     @      à7            lor" ],
			...
			toCSV: function( options, callback ) {
				...
				// GATHER DATA
				buffer = _thiÀ7    À7                    áæ            pYµ    (8            à7     @      à7            += buffer[ row ].join( cfg.delimiter ) + "\n";
					}
				}
			...
			getChartData: function( options ) {
				...
				if ( cfg.data.length == 0 ) {
					...
					if ( _this.setup.chart.type == "stock" ) {
						...
						// CAÀ7    À7                    áæ            pYµ    (8            à7     @      à7            egmentsField;
